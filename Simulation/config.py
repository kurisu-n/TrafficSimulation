...
class Defaults:
    ...
    ALLOW_EXTRA_HIGHWAYS: bool = True
    EXTRA_HIGHWAY_CHANCE: float = 0.15
    R2_R3_CHANCE_SPLIT:   float = 0.80

    # blocks
    MIN_BLOCK_SPACING:    int   = 10
    MAX_BLOCK_SPACING:    int   = 20
    # sub-blocks
    ...
    INTERNAL_POPULATION_TRAFFIC_PER_DAY = 10000
    PASSING_POPULATION_TRAFFIC_PER_DAY = 2400
    ...
    VEHICLE_OBSTACLE_PENALTY_STOP = 1_000
    ...
    VEHICLE_STUCK_DESPAWN_THRESHOLD = 120
    ...
    TRAFFIC_LIGHT_AGENT_ALGORITHM = "NEIGHBOR_PRESSURE_CONTROL"
    # "DISABLED", "FIXED_TIME", "QUEUE_ACTUATED
    # "PRESSURE_CONTROL", "NEIGHBOR_PRESSURE_CONTROL"
    # "NEIGHBOR_GREEN_WAVE", "NEIGHBOR_RL"
    ...
    SHOW_TRAFFIC_STATISTICS: bool = False
