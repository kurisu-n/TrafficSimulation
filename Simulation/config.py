...
class Defaults:
    ...
    # blocks
    BLOCK_ENTRANCE_ROAD_LEVEL: int = 0
    BLOCK_ENTRANCE_AVOID_TRAFFIC_LIGHTS = True
    MIN_BLOCK_SPACING:    int   = 6
    MAX_BLOCK_SPACING:    int   = 18

    # sub-blocks
    SUBBLOCK_CHANGE:      float = 0.3
    CARVE_SUBBLOCK_ROADS: bool  = False
    MIN_SUBBLOCK_SPACING: int   = 5
    SUBBLOCK_ROADS_HAVE_INTERSECTIONS: bool = True
    ...
    VEHICLE_ROAD_TYPES_PENALTY_R1 = 0.5
    VEHICLE_ROAD_TYPES_PENALTY_R2 = 5
    VEHICLE_ROAD_TYPES_PENALTY_R3 = 50.0
    ...
    VEHICLE_STUCK_DESPAWN_ENABLED = False
    VEHICLE_STUCK_DESPAWN_THRESHOLD = 3600
    ...
    TRAFFIC_LIGHT_AGENT_ALGORITHM = "QUEUE_ACTUATED"
    ...
    TRAFFIC_LIGHT_CLEARANCE_MAX_DURATION = 5
    ...
    SRL_INPUT_DIMENSIONS = 13 # 7, 11, 13, 17, 19
    SRL_PUNISH_STUCK = False
    SRL_PUNISH_STUCK_FACTOR = 5
    SRL_PUNISH_NEIGHBOR = True
    SRL_PUNISH_NEIGHBOR_FACTOR = 0.25
    SRL_HIDDEN_LAYERS = 10
    SRL_HIDDEN_LAYER_SIZE = 128
    ...
    STATISTICS_UPDATE_INTERVAL: int = 20
